    ...
    <main class="content">
        <header class="topbar">
            <nav class="cadastro-navbar">
                ...
                <a class="cadastro-link is-active" href="{{ route('register_funcionario') }}">Cadastro funcionario</a>
            </nav>
        </header>

        <section class="form-box">
            <h2>Novo Cadastro de Funcionario</h2>
            @if (session('success'))
            ...
            <form method="POST" action="{{ route('register_funcionario.store') }}">
                @csrf
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="bi_passaporte" value="{{ old('bi_passaporte') }}" maxlength="21" required placeholder="Digite o BI ou Passaporte">
                </div>

                <div class="input-group">
                    <label>Contacto</label>
                    <input type="text" name="contacto" value="{{ old('contacto') }}"  required placeholder="Digite o contacto (+244)">
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="endereco" value="{{ old('endereco') }}" maxlength="50" required placeholder="Digite o endereço">
                </div>

                <div class="input-group">
                    <label>Função</label>
                    <input type="text" name="funcao" value="{{ old('funcao') }}" maxlength="50" required placeholder="Digite a função">
                </div>

                <div class="input-group">
                    <label>Departamento</label>
                    <input type="text" name="departamento" value="{{ old('departamento') }}" maxlength="40" required placeholder="Digite o departamento">
                </div>
