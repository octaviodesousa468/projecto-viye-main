...
<head>
    ...
    <title>Academia - Chat Admin</title>
    <style>
        * { box-sizing: border-box; }
        ...
        main { padding: 24px; }
        .admin-nav { display: flex; gap: 10px; margin-bottom: 18px; flex-wrap: wrap; }
        .admin-link { text-decoration: none; padding: 10px 14px; border-radius: 8px; background: #e7eefc; color: #0b2447; font-weight: 600; }
        .admin-link.active { background: #0b2447; color: #fff; }
...
<body>
    <header>
        <a href="{{ route('academia') }}"><img src="{{ asset('img/jardim-logotipo122.png') }}" alt="Imagem" width="120px" height="70px" class="logo"></a>
        <h3>Academia - Chat do Administrador</h3>
    </header>
    <main>
        <nav class="admin-nav">
            <a class="admin-link" href="{{ route('academia') }}">Academia</a>
            <a class="admin-link active" href="{{ route('academia.chat') }}">Chat</a>
            <a class="admin-link" href="{{ route('perfil') }}">Perfil</a>
            <a class="admin-link" href="{{ route('dashboard') }}">Dashboard</a>
            <a href="{{ route('logout') }}" class="admin-link">Sair</a>
        </nav>
