...
<body>
    <header>
        ...
        <h3>Ambiente do Aluno - Perfil</h3>
    </header>
    <main>
        <nav class="student-nav">
            ...
            <a class="student-link active" href="{{ route('telaaluno.perfil') }}">Perfil</a>
        ...
        <section class="card">
            ...
            <p>Email: {{ session('user_email', 'aluno@exemplo.com') }}</p>
            <p>Nivel de acesso: {{ session('access_level', 'aluno') }}</p>
        </section>
    </main>
</body>
</html>
